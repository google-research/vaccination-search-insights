...
data: Global_l0_vaccination_search_insights.csv GB_vaccination_search_insights.csv regions.csv IE_vaccination_search_insights.csv US_initial.csv US_zips.csv CA_vaccination_search_insights.csv
