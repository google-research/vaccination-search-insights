...
Global_l0_vaccination_search_insights.csv: US_vaccination_search_insights.csv GB_vaccination_search_insights.csv IE_vaccination_search_insights.csv CA_vaccination_search_insights.csv
...
regions.csv: US_vaccination_search_insights.csv gb_regions.csv IE_vaccination_search_insights.csv CA_vaccination_search_insights.csv
...
data: Global_l0_vaccination_search_insights.csv US_vaccination_search_insights.csv GB_vaccination_search_insights.csv IE_vaccination_search_insights.csv CA_vaccination_search_insights.csv regions.csv